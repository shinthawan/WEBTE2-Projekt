...
<div class="container">
    <div class="wrapper">
        <form action="ENstudentView.php" method="post" enctype="multipart/form-data">
    ...
    if (isset($_POST["zobraz"])) {
        ...
        $sql3 = "SELECT nazov,hodnota,id_uzivatel,obdobie FROM zaznam WHERE obdobie = '$year' AND id_predmet = '$id' AND id_uzivatel = '$uid'";
        $result = $conn->query($sql3);
        $temp = 0;
        ...
        $temp = 0;
        $temp2 = 0;
        $sql7 = "SELECT z.nazov,z.hodnota,z.id_uzivatel,u.meno,v.znamka,v.spolu,z.id_zaznam FROM zaznam z JOIN uzivatel u ON u.id_uzivatel = z.id_uzivatel JOIN vysledok v ON z.id_uzivatel = v.id_uzivatel WHERE z.obdobie = '$year' AND z.id_predmet = '$id' AND v.id_predmet = '$id' AND v.obdobie = '$year' AND v.id_uzivatel = '$uid' GROUP BY z.nazov,z.hodnota,z.id_uzivatel,u.meno,v.znamka,v.spolu,z.id_zaznam ORDER BY z.id_zaznam";
